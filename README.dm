...
Провести емпіричне порівняння трьох алгоритмів сортування — **Timsort** (вбудований у Python), **Сортування Злиттям (Merge Sort)** та **Сортування Вставками (Insertion Sort)** 
...
| :--- | :--- | :--- | :--- | :--- |
| **1000** | 0.00007 | 0.00862 | 0.01095 | ~ 1:156 |
| **5000** | 0.00043 | 0.05724 | 0.24885 | ~ 1:578 |
| **10000** | 0.00058 | 0.00926 | 1.05339 | ~ 1:1816 |
| **20000** | 0.00125 | 0.02012 | 4.30687 | ~ 1:3445 |
